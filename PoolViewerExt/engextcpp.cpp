...
ExtExtension::ExtExtension(void)
    : m_Advanced("The extension did not initialize properly."),
      ...
      m_Advanced4("The extension requires IDebugAdvanced4."),
      ...
      m_PlmClient("The extension requires IDebugPlmClient."),
      m_PlmClient2("The extension requires IDebugPlmClient2."),
      m_PlmClient3("The extension requires IDebugPlmClient3."),
                               ...
                               _In_ ULONG TimeoutMilliseconds)
{
    ...
    GetExprU64("@$callret", static_cast<ULONG64>(-1), &RetVal);
    return RetVal;
}
...
ExtExtension::Query(_In_ PDEBUG_CLIENT Start)
{
    ...
    OPT_IF(IDebugAdvanced4, m_Advanced4);
    ...
    OPT_IF(IDebugPlmClient, m_PlmClient);
    OPT_IF(IDebugPlmClient2, m_PlmClient2);
    OPT_IF(IDebugPlmClient3, m_PlmClient3);
...
ExtExtension::Release(void)
{
    ...
    EXT_RELEASE(m_Data3);
    EXT_RELEASE(m_Data4);
    EXT_RELEASE(m_PlmClient);
    EXT_RELEASE(m_PlmClient2);
    EXT_RELEASE(m_PlmClient3);
