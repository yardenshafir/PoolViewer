...
public:
    ...
    ExtCheckedPointer<IDebugAdvanced4> m_Advanced4;
    ...
    ExtCheckedPointer<IDebugPlmClient> m_PlmClient;
    ExtCheckedPointer<IDebugPlmClient2> m_PlmClient2;
    ExtCheckedPointer<IDebugPlmClient3> m_PlmClient3;
